...
public class ModelleView extends VerticalLayout{
    ...
    public ModelleView() {
        ...
        btn1.addClickListener(e -> btn1.getUI().ifPresent(ui -> ui.navigate("konfigurator")));
        btn1.addClickListener(e -> dc.setButtonSelection(1));
        ...
        btn2.addClickListener(e -> btn2.getUI().ifPresent(ui -> ui.navigate("konfigurator")));
        btn2.addClickListener(e -> dc.setButtonSelection(2));
        ...
        btn3.addClickListener(e -> btn3.getUI().ifPresent(ui -> ui.navigate("konfigurator")));
        btn3.addClickListener(e -> dc.setButtonSelection(3));
